...
const actionLabels: Record<string, string> = {
  ...
  company_user_membership_deleted: "Usuario removido",
  ...
  user_first_login_password_changed: "Senha alterada",
  user_temporary_password_set: "Senha temporaria",
  user_password_cleared: "Senha limpa",
  user_mfa_enrolled: "2FA cadastrado",
  user_mfa_verified: "2FA confirmado",
...
const actionClasses: Record<string, string> = {
  ...
  asset_deleted: "bg-destructive/10 text-destructive border-destructive/20",
  record_created: "bg-blue-500/10 text-blue-600 border-blue-500/20",
  record_updated: "bg-cyan-500/10 text-cyan-600 border-cyan-500/20",
  record_deleted: "bg-destructive/10 text-destructive border-destructive/20",
  ...
  company_user_membership_deleted: "bg-destructive/10 text-destructive border-destructive/20",
  ...
  user_first_login_password_changed: "bg-emerald-500/10 text-emerald-600 border-emerald-500/20",
  user_temporary_password_set: "bg-amber-500/10 text-amber-600 border-amber-500/20",
  user_password_cleared: "bg-amber-500/10 text-amber-600 border-amber-500/20",
  user_mfa_enrolled: "bg-blue-500/10 text-blue-600 border-blue-500/20",
  user_mfa_verified: "bg-blue-500/10 text-blue-600 border-blue-500/20",
  stock_movement_updated: "bg-cyan-500/10 text-cyan-600 border-cyan-500/20",
  stock_movement_deleted: "bg-destructive/10 text-destructive border-destructive/20",
